        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-5 space-y-6 pt-6">
          <FieldInput 
            ...
            />
					...
					<FieldInput title="Salary" subtitle="Please specifiy the estimated salary range for the role">
            ...
            />
					...
					<FieldInput title="Perks and Benefits" subtitle="Encourage more people to apply by sharing the attractive rewards and benefits you offer tour employees">
